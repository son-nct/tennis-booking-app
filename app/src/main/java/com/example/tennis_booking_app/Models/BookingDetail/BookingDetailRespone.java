...
public class BookingDetailRespone {
    ...
    public BookingDetailRespone(int id, int bookingId, int courtId, int slotId, int totalPrice, int totalPriceAfterDiscount, int voucherId, int statusId, int insertedBy, int updateBy, int ratedStar, Date bookedPlayDate, Date insertedDate, Date updatedDate, String note, boolean active, List<Booking> bookings) {
        this.id = id;
