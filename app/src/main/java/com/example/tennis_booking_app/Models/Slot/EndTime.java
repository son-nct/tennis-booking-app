...
public class EndTime {
    ...
    public EndTime(int ticks, int days, int hours, int milliseconds, int minutes, int seconds, int totalDays, int totalHours, int totalMilliseconds, int totalMinutes, int totalSeconds) {
        Ticks = ticks;
        Days = days;
        Hours = hours;
