...
public class Booking {
    ...
    public Booking(int id, int vendorId, int totalPrice, int updatedBy, int statusId, int paymentId, Date insertedDate, Date updatedDate, String note, boolean active, BookingDetail bookingDetail) {
        this.id = id;
