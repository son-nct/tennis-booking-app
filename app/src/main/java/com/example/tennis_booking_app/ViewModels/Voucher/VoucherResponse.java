...
public class VoucherResponse {
    ...
    public VoucherResponse(int count, int firstItemOnPage, boolean hasNextPage, boolean hasPreviousPage, boolean isFirstPage, boolean isLastPage, int pageNumber, int pageCount, int pageSize, int lastItemOnPage, List<Voucher> value) {
        Count = count;
    ...
    public List<Voucher> getValue() {
        return Value;
    }

    public void setValue(List<Voucher> value) {
        Value = value;
    }
}
