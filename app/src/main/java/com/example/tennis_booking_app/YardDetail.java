...
public class YardDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrSan.add(new SanTennis("Sân 1A - Sân đất nện","36.57m x 18.29m","70.000 - 300.000 vnđ",R.drawable.san1a));
        arrSan.add(new SanTennis("Sân 2A - Sân PVC","36.57m x 18.29m","100.000 - 350.000 vnđ",R.drawable.san2a));
        arrSan.add(new SanTennis("Sân 2B - Sân cỏ","36.57m x 18.29m","150.00 - 400.000 vnđ",R.drawable.san2b));
